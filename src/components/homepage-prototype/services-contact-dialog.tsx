...
export function ServicesContactDialog({ onClose, onRequestCall112 }: { onClose: () => void; onRequestCall112: () => void }) {
  return <Modal title="სად დავრეკო ან ვის მივწერო?" onClose={onClose}>
      ...
      <div className={styles.contactCards}>
        {serviceContacts.map(contact => <ServiceContactCard key={contact.id} contact={contact} onRequestCall112={onRequestCall112} />)}
      </div>
  </Modal>;
}
