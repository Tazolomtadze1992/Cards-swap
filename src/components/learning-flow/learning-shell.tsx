...
export function LearningShell({ children, kind, current, total, stage, young = false }: {
  young?: boolean;
  ...
  return <div className={styles.page}>
    ...
    <main className={styles.shell} data-stage={stage}>
      {stage !== "recommendation" && <><div className={styles.topbar}>
        ...
        <Button asChild variant="subtle" size="icon"><Link href={young ? "/prototypes/learning/6-9" : "/prototypes/learning"} aria-label="სწავლის გვერდზე დაბრუნება"><Icon name="close" /></Link></Button>
      </div>
