...
Homepage navigation and the homepage `ყველას ნახვა` button open this page directly. In the homepage card deck, the FAQ card's first click runs the existing 650ms expansion choreography. The expanded card is one unified click target: a second click anywhere on the large card, including its visible action label, opens this page. The stakeholder cards playground keeps the original expand-and-close interaction and never navigates away.
